...
function ComputerButton() {
    const computerName = useSelector(state => state.rps.computerButtonName);
    const state = useSelector(state => state.rps.computerButtonSecons);
   
    return (
        <div className='buttons-main'>
            <h3 className='button-text'>COMPUTER PICKED</h3>
            {
                state>0 ?
