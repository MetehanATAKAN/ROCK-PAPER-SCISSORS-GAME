...
import {renameButtonName, renameComputerButtonName} from "../redux/slice/RpsSlice";
import {useDispatch} from "react-redux";

function Buttons() {
    
    const dispatch = useDispatch();
    const renamebuttonName=(name)=> {
        dispatch(renameButtonName(name));
    }
    dispatch(renameComputerButtonName());
    return (
        <div className='buttons'>      
            <div className='top-buttons' >
                <Link to="/game" onClick={()=>renamebuttonName("scıssors")}>
                    <div id='scıssors-button' className='inner-button'>
                ...
                <Link to="/game" onClick={()=>renamebuttonName("paper")}>
                    <div id='paper-button' className='inner-button'>
            ...
            <div  className='bot-buttons'>
                <Link to="/game" onClick={()=>renamebuttonName("rock")}>
                    <div id='rock-button'>
